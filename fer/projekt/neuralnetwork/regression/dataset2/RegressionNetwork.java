...
public class RegressionNetwork extends NeuralNetwork {
	...
	public void setupNetwork() {
		...
		for (int i = 0; i < learningDatasetSize - 1; i++, testInput = learningDataset.get(i)) {
			...
			double in[] = {testInput.getMotor(),testInput.getScrew(),testInput.getPgain(),testInput.getVgain()};
	...
	public static void main(String[] args) {
		...
		//RegressionNetwork network = new RegressionNetwork(Paths.get("RegressionNetwork"),Paths.get("servo.data"));
